...
public:
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "CityEngine")
...
UCLASS(Abstract)
class CITYENGINEPLUGIN_API URuleAttribute : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "CityEngine")
...
UCLASS(Abstract)
class CITYENGINEPLUGIN_API UArrayAttribute : public URuleAttribute
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class CITYENGINEPLUGIN_API UStringAttribute final : public URuleAttribute
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class CITYENGINEPLUGIN_API UStringArrayAttribute final : public UArrayAttribute
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class CITYENGINEPLUGIN_API UFloatAttribute final : public URuleAttribute
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class CITYENGINEPLUGIN_API UFloatArrayAttribute final : public UArrayAttribute
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class CITYENGINEPLUGIN_API UBoolAttribute final : public URuleAttribute
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class CITYENGINEPLUGIN_API UBoolArrayAttribute final : public UArrayAttribute
{
	GENERATED_BODY()
