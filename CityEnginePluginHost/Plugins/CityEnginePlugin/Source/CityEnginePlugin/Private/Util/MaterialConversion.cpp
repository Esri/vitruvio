...
EBlendMode ChooseBlendModeFromOpacityMap(const CityEngine::FTextureData& OpacityMapData, bool UseAlphaAsOpacity)
{
...
EBlendMode ChooseBlendMode(const CityEngine::FTextureData& OpacityMapData, double Opacity, EBlendMode BlendMode, bool UseAlphaAsOpacity)
{
...
{
	TPromise<CityEngine::FTextureData> Promise;
	UObject* Outer;
	TMap<FString, CityEngine::FTextureData>& Cache;
...
public:
	FLoadTextureTask(TPromise<CityEngine::FTextureData>&& InPromise, UObject* Outer, TMap<FString, CityEngine::FTextureData>& Cache,
	...
	void DoTask(ENamedThreads::Type CurrentThread, const FGraphEventRef& MyCompletionGraphEvent)
	{
		...
		CityEngine::FTextureData TextureData = FCityEngineModule::Get().DecodeTexture(Outer, ImagePath, TextureKey);
		{
