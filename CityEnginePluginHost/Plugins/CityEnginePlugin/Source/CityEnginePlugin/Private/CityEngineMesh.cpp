...
FCityEngineMesh::~FCityEngineMesh()
{
	...
	FCityEngineModule* VitruvioModule = FCityEngineModule::GetUnchecked();
...
void FCityEngineMesh::Build(const FString& Name, TMap<CityEngine::FMaterialAttributeContainer, TObjectPtr<UMaterialInstanceDynamic>>& MaterialCache,
						  TMap<FString, CityEngine::FTextureData>& TextureCache, TMap<UMaterialInterface*, FString>& UniqueMaterialIdentifiers,
						  ...
						  UWorld* World)
{
	...
	FCityEngineModule::Get().RegisterMesh(StaticMesh);
	...
	CityEngine::FCollisionData CollisionData = {Indices, Vertices};
