...
void SMaterialReplacementDialogWidget::UpdateReplacementTable()
{
	...
	StaticMeshComponents.Add(CityEngineComponent->GetGeneratedModelComponent());
	...
	for (UStaticMeshComponent* StaticMeshComponent : StaticMeshComponents)
	{
		for (const auto& MaterialSlotName : StaticMeshComponent->GetMaterialSlotNames())
		{
			...
			const FString& MaterialIdentifier = CityEngineComponent->GetMaterialIdentifier(SourceMaterial);
