...
class FCityEngineEditorModule final : public IModuleInterface
{
public:
	...
	static FCityEngineEditorModule& Get()
	{
		return FModuleManager::LoadModuleChecked<FCityEngineEditorModule>("CityEnginePluginEditor");
	}
