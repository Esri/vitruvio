...
protected:
	...
	TArray<UCityEngineComponent*> GetCityEngineActorsToApplyReplacements(bool bIncludeAll) const;
...
public:
	...
	static void OpenDialog(UCityEngineComponent* CityEngineComponent, TOnWindowClosed OnWindowClosed, bool bGeneratedWithoutReplacements,
						   const FVector2D& DialogSize = {800, 600})
	{
		...
		TSharedRef<TDialogType> ReplacementPicker = SNew(TDialogType)
			.VitruvioComponent(CityEngineComponent)
